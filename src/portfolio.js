...
const greeting = {
  ...
  subTitle: emoji(
    "A Newbie Coder , Cracker , Gamer , Youtuber , Logo Maker Many More Skills At This Age 😅."
  ),
  TelegramLink:
    "https://t.me/Pirated143",
...
const contactInfo = {
  ...
  subtitle:
    "Discuss With Me or just want to say hi? My Inbox is Open For You :).",
  Telegram: "@Pirated143",
  email_address: "Pirated143@gmail.com"
};
